...
Supplement~1 provides the corresponding corrected PatchMNIST reconstructions and patterns, the per-seed C--D results, the exploratory BBBC022 ablation, and the implementation-provenance analysis.
