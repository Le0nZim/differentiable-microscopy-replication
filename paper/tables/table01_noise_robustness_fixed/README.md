...
- **Shared run:** also produces [Figure 6](../../figures/figure06_noise_robustness_fixed/).
...
Config: `configs/paper_aligned_patchmnist_noise_table_v3_fixed.yaml`

## Reproduce

```bash
python scripts/run_rr1_v3_noise_table.py \
  --config configs/paper_aligned_patchmnist_noise_table_v3_fixed.yaml \
  --output-root experiments/noise_robustness/rr1_v3_normalized_full_fixed \
...
Two-GPU launcher: `bash scripts/launch_clean_split_fixed.sh`
