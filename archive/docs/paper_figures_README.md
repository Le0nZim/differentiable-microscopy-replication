...
Where a `*_fixed` folder exists, that is the published variant (clean split). Figure 4 is `figure04_segmentation` from `experiments/figure04_segmentation/task_aware`.
