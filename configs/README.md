...
YAML grouped by paper slug. Shared bases and splits live in `_shared/`.

| Path | Used by |
|---|---|
| `_shared/base_patchmnist.yaml` | PatchMNIST tests and matrices |
| `_shared/base_bbbc022_substitute.yaml` | Table 3 / Figure 3 bases |
