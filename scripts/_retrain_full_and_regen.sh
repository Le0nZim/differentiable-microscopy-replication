...
$PY scripts/fig89_mcf7_swinir_fix_train.py --condition wswinir --device "$DEV" \
...
froz = np.asarray(Image.open('experiments/figure89_mcf7_swinir_highres_fix_v1/figures/figure8_paper_style.png').convert('RGB'))
