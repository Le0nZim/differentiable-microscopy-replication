...
Usage:
  python scripts/reproduce_fig9.py --config configs/reproduce_fig9_bbbc021_tubulin_x16_swinir_vs_cnn.yaml --device cuda:0
"""
...
def main() -> None:
    ...
    runs_dir = ROOT / (args.runs_dir or rep.get("runs_dir", "experiments/figure89_mcf7_swinir_highres_fix_v1/runs"))
