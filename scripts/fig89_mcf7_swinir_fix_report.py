...
experiments/figure89_mcf7_swinir_highres_fix_v1/runs/{wswinir,transpose256,wcnn64}/,
...
Usage:
  ...
  python scripts/fig89_mcf7_swinir_fix_report.py --device cuda:0 --fig8-indices 3 7 11
"""
