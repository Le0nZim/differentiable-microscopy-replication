...
Identical three-stage regime to scripts/figure04_segmentation/train.py (paper §5.3 / B.0.1)
...
``experiments/figure04_segmentation/calibrated/runs/``.

Usage:
  python scripts/figure04_segmentation/calibrated_train.py --device cuda:0                 # all 6 cells
  python scripts/figure04_segmentation/calibrated_train.py --device cuda:1 --cells x64 x256  # subset
  python scripts/figure04_segmentation/calibrated_train.py --device cuda:0 --smoke         # fast validation
"""
...
CONFIG_PATH = ROOT / "experiments/figure04_segmentation/calibrated/configs/fig4_seg_calibrated_base.yaml"
OUT = ROOT / "experiments/figure04_segmentation/calibrated/runs"
