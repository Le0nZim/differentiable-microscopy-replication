...
Mirrors scripts/figure04_segmentation/report.py but points at
``experiments/figure04_segmentation/calibrated`` and uses the calibrated
...
_spec = importlib.util.spec_from_file_location("fig4calrun", ROOT / "scripts/figure04_segmentation/calibrated_train.py")
...
EXP = ROOT / "experiments/figure04_segmentation/calibrated"
RUNS = EXP / "runs"
METRICS = EXP / "metrics"
