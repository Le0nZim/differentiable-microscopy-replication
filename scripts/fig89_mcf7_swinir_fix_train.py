...
Isolated writes to experiments/figure89_mcf7_swinir_highres_fix_v1/runs/<condition>/.
...
Usage:
  ...
  python scripts/fig89_mcf7_swinir_fix_train.py --condition transpose256 --device cuda:1 --epochs 60 ...
  python scripts/fig89_mcf7_swinir_fix_train.py --condition wcnn64 --device cuda:1 --epochs 72 ...
  python scripts/fig89_mcf7_swinir_fix_train.py --smoke --condition wswinir --device cuda:0
"""
...
EXP = ROOT / "experiments/figure89_mcf7_swinir_highres_fix_v1"
CFG = EXP / "configs/fig89_mcf7_swinir_fix.yaml"
