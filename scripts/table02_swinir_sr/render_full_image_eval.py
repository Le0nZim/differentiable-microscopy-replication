...
For each benchmark dataset (Set5, Set14, BSD100, Urban100, Manga109) this:
  ...
  2. GENUINELY ATTEMPTS direct full-image inference (single forward pass on the
     ...
     fixed 64x64 input (see archive/configs/swinir/am4_table2_full.yaml line 100 and
...
CONFIG = ROOT / "configs/table02_swinir_sr/full.yaml"
RUN    = ROOT / "experiments/table02_swinir_sr/full"
