...
Outputs -> experiments/figure3_bbbc022_swinir_fix_v1/sanity/<test>/

Usage:
  python scripts/fig3_swinir_fix_sanity.py --device cuda:0                 # all tests
  python scripts/fig3_swinir_fix_sanity.py --device cuda:0 --tests pairing,tiny_overfit
"""
...
SANITY = ROOT / "experiments/figure3_bbbc022_swinir_fix_v1/sanity"
