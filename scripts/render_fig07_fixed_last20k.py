...
The existing figure07_swinir_standard_sr_fixed folder used best.pt, which for
...
FIG_DIR = ROOT / "paper/figures/figure07_swinir_standard_sr_fixed_last20k"
...
def render() -> dict:
    mod = _load("fig7_full", ROOT / "scripts/render_fig07_full_image_eval.py")
...
def write_folder(B, meta: dict) -> None:
    ...
    (d / "CHECKPOINT.md").write_text(
        ...
        "Sibling folder figure07_swinir_standard_sr_fixed used best.pt, which for "
