...
NOISE_CFG="${REPL}/configs/table01_noise_robustness/noise_table.yaml"
NOISE_OUT="${REPL}/experiments/table01_noise_robustness"
SWIN_CFG="${REPL}/configs/table02_swinir_sr/full.yaml"
SWIN_BASE="${REPL}/experiments/table02_swinir_sr"
...
"${PY}" "${REPL}/scripts/table01_noise_robustness/run.py" \
...
"${PY}" "${REPL}/scripts/table02_swinir_sr/run.py" \
...
"${PY}" "${REPL}/scripts/_shared/finalize_clean_split.py" \
