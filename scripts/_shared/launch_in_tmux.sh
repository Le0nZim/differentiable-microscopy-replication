...
#
# Usage:
#   scripts/_shared/launch_in_tmux.sh SESSION_NAME GPU_ID LOG_FILE COMMAND...
#
# Example:
#   scripts/_shared/launch_in_tmux.sh mcf7_li_swinir 1 experiments/swinir_or_highres/mcf7_paper_direct_full/run.log \
