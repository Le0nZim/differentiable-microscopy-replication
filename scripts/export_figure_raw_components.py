...
AM4 = ROOT / "experiments/swinir_or_highres/am4_swinir_table2_resolution/full"
FIG10_RUNS = ROOT / "experiments/figure10_bbbc022_ablation_v1/runs"
...
Q_FIG89 = WS / "quarantine_obsolete/replication/experiments/figure89_mcf7_swinir_highres_fix_v1"
V3_WSWINIR = Q_FIG89 / "runs_full/wswinir"
V3_TRANSPOSE = Q_FIG89 / "runs/transpose256_sp8"
V3_WCNN = Q_FIG89 / "runs/wcnn64_sp8"
V3_SUPERPIXEL = 8

CFG8 = ROOT / "configs/reproduce_fig8_bbbc021_tubulin_x16_swinir.yaml"
CFG9 = ROOT / "configs/reproduce_fig9_bbbc021_tubulin_x16_swinir_vs_cnn.yaml"
...
def export_fig07() -> None:
    ...
    _write_manifest(
        ...
        {
            "figure": "7",
            "script": "paper_ready_results/scripts/render_fig07_full_image_eval.py",
...
def export_fig08(device) -> None:
    f8 = _load_mod("reproduce_fig8", ROOT / "scripts/reproduce_fig8.py")
...
def export_fig09(device) -> None:
    f9 = _load_mod("reproduce_fig9", ROOT / "scripts/reproduce_fig9.py")
    ...
    try:
        ...
        _write_manifest(
            ...
            {
                "figure": "9",
                "script": "scripts/reproduce_fig9.py",
...
def export_fig10() -> None:
    f10 = _load_mod("reproduce_fig10", ROOT / "scripts/reproduce_fig10.py")
    ...
    _write_manifest(
        ...
        {
            "figure": "10",
            "script": "scripts/reproduce_fig10.py",
