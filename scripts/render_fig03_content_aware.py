...
def main() -> None:
    ...
    ap.add_argument("--exp-root", default=str(ROOT / "experiments/ablations/bbbc022_content_aware_v2"))
    ap.add_argument("--out-dir", default=str(ROOT / "paper/figures/figure03_content_aware"))
