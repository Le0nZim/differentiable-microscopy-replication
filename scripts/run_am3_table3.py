...
This script writes ONLY under experiments/ablations/am3_table3_resolution and
...
OUT = ROOT / "experiments/ablations/am3_table3_resolution"
...
def bbbc022_base(device: str) -> dict:
    cfg = load_experiment_config(ROOT / "configs/base_bbbc022_substitute.yaml")
...
def patchmnist_base(device: str) -> dict:
    cfg = load_experiment_config(ROOT / "configs/base_patchmnist.yaml")
    cfg["experiment"]["device"] = device
    return cfg
