...
``experiments/figure4_bbbc022_segmentation_fix_v1/runs/`` and reuses the helpers
in ``scripts/fig4_seg_fix_report.py``. Run from the ``replication/`` directory:

    .venv/bin/python scripts/fig4_seg_fix_export_tiles.py --device cuda:0 --seed 42 --k 5
"""
...
_spec = importlib.util.spec_from_file_location("fig4report", ROOT / "scripts/fig4_seg_fix_report.py")
