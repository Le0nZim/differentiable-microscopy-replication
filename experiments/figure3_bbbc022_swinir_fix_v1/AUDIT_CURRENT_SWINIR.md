...
| Frozen base microscopes | `experiments/ablations/bbbc022_content_aware_v2/bbbc022_{comp}_{pattern}_seed42/checkpoints/best.pt` |
| Output | `experiments/ablations/bbbc022_content_aware_v2/swinir/{comp}_{pattern}/` and `swinir/swinir_results.csv` |
