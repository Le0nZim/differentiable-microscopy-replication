...
Sources of truth:
- Table-2/Fig-7 recipe: `configs/swinir/am4_table2_full.yaml` + `scripts/run_am4_swinir_table2.py` + `src/baselines/swinir/{am4_table2,losses,table2_pipeline,model_wrapper}.py`.
