...
CFG="experiments/figure3_bbbc022_swinir_fix_v1/configs/paper_faithful_pixel_perceptual_gan.yaml"
EXP="experiments/figure3_bbbc022_swinir_fix_v1"
cd "$REPO" || exit 1
...
(
  ...
  python scripts/fig3_swinir_fix_train.py --config "$CFG" \
