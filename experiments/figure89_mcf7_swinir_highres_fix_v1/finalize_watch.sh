...
# Usage: setsid nohup bash experiments/figure89_mcf7_swinir_highres_fix_v1/finalize_watch.sh > .../finalize.log 2>&1 &
set -uo pipefail
...
$PY scripts/fig89_mcf7_swinir_fix_report.py --device cuda:1
echo "[finalize] DONE"
