...
Per-run wiring is also re-verified at training time: `scripts/run_am3_table3.py`
...
Source config: `configs/matrices/bbbc022_x16_ablation_matrix.yaml`
(base `configs/base_bbbc022_substitute.yaml`).
...
(`scripts/run_am3_table3.py`) uses a **phase-preserving scaled** schedule, applied
