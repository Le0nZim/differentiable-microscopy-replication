...
faithfully in `experiments/figure04_segmentation/stage1_frozen/`. This
...
$PY scripts/figure04_segmentation/sanity.py --device cuda:0
# 2) verified re-run of the 6-cell matrix (Stage 2+3; Stage 1 reused frozen)
$PY scripts/figure04_segmentation/train.py --device cuda:0 --seed 42
# 3) metrics CSV + paper-layout Figure 4 + bars + REPORT tables
$PY scripts/figure04_segmentation/report.py --device cuda:0 --seed 42 --k 5
# 4) per-panel tiles + viridis composites for PowerPoint
$PY scripts/figure04_segmentation/export_tiles.py --device cuda:0 --seed 42 --k 5
```
