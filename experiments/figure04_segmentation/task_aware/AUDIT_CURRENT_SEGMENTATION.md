...
Isolated audit for `experiments/figure04_segmentation/task_aware/`. Read-only
...
`experiments/figure04_segmentation/stage1_frozen/`. It runs the paper's
...
Audited files:
- `configs/figure04_segmentation/stage1_frozen.yaml`
- `scripts/figure04_segmentation/train_stage1_frozen.py`
